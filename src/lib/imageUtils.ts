const S3_BASE_URL =
  ...
  'https://sapiens-engine-assets.s3.ap-northeast-2.amazonaws.com';
...
export function getPhilosopherImage(
  id: string,
  size: 'portraits' | 'thumbnails' = 'portraits',
): string {
 ...
 * Custom NPC URL
 */
export function getCustomNpcImage(
  npcId: string,
...
export function getModeratorImage(
  moderatorId: string,
  size: 'portraits' | 'thumbnails' = 'portraits',
): string {
