...
import PhilosopherDetailsModal from '../components/PhilosopherDetailsModal';
                          ...
                          <div key={npcId} className="selected-philosopher-container">
                            <div className="selected-philosopher-image-wrapper">
                              <img
                                ...
                                onError={(e) => {
                                  e.currentTarget.src = getDefaultAvatar(npc.name);
                                }}
                              />
                              <button
                                onClick={() => {
                      ...
                      >
                        ...
                        >
                          <img
                            ...
                            className="philosopher-image-small"
                            onError={(e) => {
                              e.currentTarget.src = getDefaultAvatar(philosopher.name);
                            }}
                          />
